...
public class OffersForm extends Form<LocalDate> {
    ...
    public OffersForm(@NonNull String id, @NonNull LocalDate from, @NonNull LocalDate to) {
        super(id);
    ...
    private String convert(DateField field) {
        ...
        return OffersPage.FORMATTER.format(localDate);
    }
